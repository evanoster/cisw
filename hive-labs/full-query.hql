...
STORED AS TEXTFILE LOCATION 'wasb://mrs-spark@alizaidi.blob.core.windows.net/HdiSamples/HdiSamples/SensorSampleData/hvac/'
...
CREATE EXTERNAL TABLE building(buildingid BIGINT, buildingmgr STRING, 
    ...
    country STRING) 
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' 
STORED AS TEXTFILE LOCATION 'wasb://mrs-spark@alizaidi.blob.core.windows.net/HdiSamples/HdiSamples/SensorSampleData/building/';
